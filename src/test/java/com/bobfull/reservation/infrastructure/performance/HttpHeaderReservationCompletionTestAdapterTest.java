...
class HttpHeaderReservationCompletionTestAdapterTest {

    private final HttpHeaderReservationCompletionTestAdapter hook = new HttpHeaderReservationCompletionTestAdapter();
