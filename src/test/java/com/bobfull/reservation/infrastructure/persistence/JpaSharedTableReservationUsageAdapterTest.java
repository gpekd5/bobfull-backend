...
class JpaSharedTableReservationUsageAdapterTest {
    ...
    void 연결된_회차의_활성_예약_여부를_예약_도메인_기준으로_조회한다() {
        ...
        JpaSharedTableReservationUsageAdapter adapter = new JpaSharedTableReservationUsageAdapter(reservationRepository);
