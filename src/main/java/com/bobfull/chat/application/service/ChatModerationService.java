...
public class ChatModerationService {
    ...
    private AiModerationResponse ruleResponse(com.bobfull.chat.application.dto.ModerationResult result) {
        return new AiModerationResponse(result, RULE_PROVIDER, RULE_MODEL, null, null, null);
    }
    private AnalysisResponse ruleAnalysis(com.bobfull.chat.application.dto.ModerationResult result) {
