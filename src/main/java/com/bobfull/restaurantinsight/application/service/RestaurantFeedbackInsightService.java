...
import com.bobfull.restaurantinsight.infrastructure.ai.RestaurantFeedbackPrompt;
...
public class RestaurantFeedbackInsightService {
    ...
    public void analyze(Long messageId) {
        ...
        java.util.List<RestaurantFeedbackAnalysis.Item> rawItems = !result.analysis().relevant() || result.analysis().items() == null ? java.util.List.of() : result.analysis().items();
        ...
        java.util.List<RestaurantFeedbackAnalysis.Item> validItems = rawItems.stream()
