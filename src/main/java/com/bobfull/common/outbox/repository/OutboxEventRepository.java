package com.bobfull.common.outbox.repository;
...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, Long> {
    ...
    List<Long> findDueEventIdsByTypes(
            @Param("status") OutboxEventStatus status,
            @Param("now") Instant now,
            @Param("eventTypes") List<OutboxEventType> eventTypes,
            Pageable pageable
    );
    ...
    List<Long> findStaleProcessingEventIdsByTypes(
            @Param("status") OutboxEventStatus status,
    ...
    int complete(
            @Param("id") Long id,
            @Param("processing") OutboxEventStatus processing,
            @Param("completed") OutboxEventStatus completed,
            @Param("token") String token,
            @Param("now") Instant now
    );
    ...
    int fail(
            @Param("id") Long id,
            @Param("processing") OutboxEventStatus processing,
            @Param("nextStatus") OutboxEventStatus nextStatus,
            @Param("token") String token,
