...
완료 검증 API와 웹훅이 동시에 도착하거나 반복될 때 결과가 한 번만 반영되는지 검증한다. 상세 API·상태 계약은 [project-context.md](../../product/project-context.md), [API 명세](../../api/bobfull-api-spec-complete.md), [erd.md](../../data/erd.md)를 따른다.
