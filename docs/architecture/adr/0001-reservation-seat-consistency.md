...
동일 TimeSlot의 동시 최초 예약 요청에서 활성 Reservation 또는 유효 CREATE READY의 성공 건수가 최대 1건인지 검증한다. 좌석 계산과 상태의 상세 계약은 [project-context.md](../../product/project-context.md), [erd.md](../../data/erd.md), [API 명세](../../api/bobfull-api-spec-complete.md)를 따른다.
