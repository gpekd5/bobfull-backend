...
- V3 Sprint Mode의 세부 검증·Evidence·최신 Head 재검토 기준은 `AGENTS.md`, `docs/ai/ai-workflow.md`, `docs/ai/ai-review-guide.md`, `skills/bobfull-pr-review/SKILL.md`를 따른다.
...
- 새 Issue 제목은 `docs/engineering/issue-title-rules.md`의 범위·유형 규칙을 따른다.
