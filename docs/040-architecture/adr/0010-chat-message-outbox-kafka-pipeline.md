...
- 주요 Evidence: `docs/110-records/evidence/v3/59-kafka-ai-pipeline/README.md`, `docs/110-records/evidence/v3/192-ai-worker-scaling/README.md`, `docs/110-records/evidence/v3/258-moderation-partition-key/README.md`, `docs/110-records/evidence/v3/274-outbox-async-vs-kafka/README.md`
