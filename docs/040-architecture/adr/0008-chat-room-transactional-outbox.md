...
대표 Before/After 실패 경계와 Outbox 원자 저장·롤백, PENDING 처리, 멱등성, 5회 재시도 후 FAILED, 단일 Claim, stale 회수를 자동 테스트와 `docs/110-records/evidence/v3/176-chatroom-outbox/README.md`로 확인한다.
