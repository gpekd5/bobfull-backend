...
> API 계약의 최우선 기준은 [`bobfull-api-spec-complete.md`](../api/bobfull-api-spec-complete.md)다. 이 문서가 API 명세와 충돌하면 API 명세를 따른다.
...
- API 명세: [`bobfull-api-spec-complete.md`](../api/bobfull-api-spec-complete.md)
- 데이터 모델: [`erd.md`](../data/erd.md)
- 논리 책임 경계: [`architecture.md`](../architecture/architecture.md)
- 도메인 변경 영향: [`domain-dependencies.md`](../architecture/domain-dependencies.md)
